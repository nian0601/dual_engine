...
GLE(void,      GetProgramInfoLog,       GLuint program, GLsizei bufSize, GLsizei* lenght, GLchar* infoLog) \
GLE(GLuint,    CreateShader,            GLenum type) \
GLE(GLuint,    DeleteShader,            GLuint shader) \
...
GLE(void,      GenVertexArrays,         GLsizei n, GLuint *buffers) \
